                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button"
                        ...
                        @switch(Session::get('lang'))
                            @case('vi')
                                <img src="{{ URL::asset('/assets/images/flags/vn.svg') }}" class="rounded" alt="Header Language"
                                    height="18" />
                            @break
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <a href="{{ route('language', 'en') }}" class="dropdown-item notify-item language py-2"
                            data-lang="en" title="English">
                            <img src="{{ URL::asset('assets/images/flags/us.svg') }}" alt="user-image"
                                class="me-2 rounded" height="18" />
                            <span class="align-middle">English</span>
                        </a>
                        <a href="{{ route('language', 'vi') }}" class="dropdown-item notify-item language py-2"
                            data-lang="vi" title="Vietnamese">
                            <img src="{{ URL::asset('assets/images/flags/vn.svg') }}" alt="user-image"
                                class="me-2 rounded" height="18" />
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        ...
                        <div class="p-2">
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="https://nuhoangcodon99.github.io"
                                        target="_blank">
                                ...
                                <div class="col">
                                    <a class="dropdown-icon-item" href="https://github.com/nuhoangcodon99/DichVu-MXH"
                                        target="_blank">
                                ...
                                <div class="col">
                                    <a class="dropdown-icon-item" href="https://www.facebook.com/bengokyeuanh.99"
                                        target="_blank">
                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span
                                    class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{ Auth::user()->roleName }}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
